...
public class CompetitionService {
    ...
    public CompetitionService(AmazonS3Client amazonS3Client, CompetitionInfoRepository competitionInfoRepository, CompetitionDocsRepository competitionDocsRepository, CompetitionTypeRepository competitionTypeRepository) {
